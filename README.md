...
> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/d2denis/poguawa/tree/vless)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `你的id` | VLESS 用户 ID，用于身份验证，为 UUID 格式 |
